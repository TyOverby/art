...
fn main() {
    // https://www.openstreetmap.org/api/0.6/map?bbox=-122.6354,47.3209,-122.5512,47.3455
    let f = File::open("C:\\Users\\Ty\\Downloads\\ny.osm").unwrap();
    ...
    for poly in all_polys {
        let scaled = all_coords[poly].iter().map(|&(lon, lat)| {
